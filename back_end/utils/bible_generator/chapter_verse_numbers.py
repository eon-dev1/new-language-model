# chapter_verse_numbers.py


"""
This module provides structured data on Bible books, chapters, and number of verses per chapter.
The data is sourced from ESV (English Standard Version) chapter counts.

It defines a constant dictionary where:
- Keys are book names (str)
- Values are lists of tuples: (chapter: int, num_verses: int)

This format allows easy import and querying, e.g., for database population or validation scripts.

Side effects:
- None; this is pure data and has no runtime effects when imported.
"""
...
BIBLE_CHAPTER_VERSES = {
    ...
    "Matthew": [
        ...
        (11, 30), (12, 49), (13, 58), (14, 36), (15, 39), (16, 28), (17, 26), (18, 34), (19, 30), (20, 34),
        (21, 46), (22, 46), (23, 38), (24, 51), (25, 46), (26, 75), (27, 66), (28, 20)
    ],
    "Mark": [
        (1, 45), (2, 28), (3, 35), (4, 41), (5, 43), (6, 56), (7, 36), (8, 38), (9, 48), (10, 52),
        (11, 32), (12, 44), (13, 37), (14, 72), (15, 46), (16, 20)
    ],
    "Luke": [
        (1, 80), (2, 52), (3, 38), (4, 44), (5, 39), (6, 49), (7, 50), (8, 56), (9, 62), (10, 42),
        (11, 54), (12, 59), (13, 35), (14, 35), (15, 32), (16, 31), (17, 36), (18, 43), (19, 48), (20, 47),
        (21, 38), (22, 71), (23, 55), (24, 53)
    ],
    "John": [
        (1, 51), (2, 25), (3, 36), (4, 54), (5, 46), (6, 71), (7, 52), (8, 48), (9, 41), (10, 42),
        (11, 57), (12, 50), (13, 38), (14, 31), (15, 27), (16, 33), (17, 26), (18, 40), (19, 42), (20, 31),
        (21, 25)
    ],
    "Acts": [
        (1, 26), (2, 47), (3, 26), (4, 37), (5, 42), (6, 15), (7, 60), (8, 39), (9, 43), (10, 48),
        (11, 30), (12, 25), (13, 52), (14, 28), (15, 40), (16, 40), (17, 34), (18, 28), (19, 41), (20, 38),
        (21, 40), (22, 30), (23, 35), (24, 26), (25, 27), (26, 32), (27, 44), (28, 30)
    ],
    "Romans": [
        (1, 32), (2, 29), (3, 31), (4, 25), (5, 21), (6, 23), (7, 25), (8, 39), (9, 33), (10, 21),
        (11, 36), (12, 21), (13, 14), (14, 23), (15, 33), (16, 26)
    ],
    "1 Corinthians": [
...
def get_chapters_for_book(book_name: str) -> list[tuple[int, int]]:
    """
    Retrieve the list of (chapter, num_verses) for a specific book.
    
    Args:
        book_name (str): The name of the book (case-sensitive, as per ESV).
    
    Returns:
        list[tuple[int, int]]: List of chapter and verse counts, or empty list if book not found.
    """
    return BIBLE_CHAPTER_VERSES.get(book_name, [])

def get_all_books() -> list[str]:
    """
    Retrieve a list of all book names.
    
    Returns:
        list[str]: Sorted list of book names.
    """
    return sorted(BIBLE_CHAPTER_VERSES.keys())